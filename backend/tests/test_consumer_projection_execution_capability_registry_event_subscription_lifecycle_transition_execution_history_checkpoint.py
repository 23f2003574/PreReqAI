...
class TestBuildCheckpointForEmptyHistory:
    ...
    def test_build_checkpoint_for_empty_history(self):
        ...
        checkpoint = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryCheckpointBuilder().build(
            history,
            cursor,
        )
...
class TestRejectNoneHistory:
    ...
    def test_reject_none_history(self):
        ...
        with pytest.raises(
            ...
            ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryCheckpointBuilder().build(
                None,
                cursor,
            )
...
class TestDeterministicOutput:
    ...
    def test_deterministic_output(self):
        ...
        builder = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryCheckpointBuilder()
