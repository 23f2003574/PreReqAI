...
class TestEmptyHistoryWindow:
    ...
    def test_empty_history_window(self):
        ...
        window = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyEvaluationHistoryWindowBuilder().build(
            history,
            0,
            5,
        )
...
class TestRejectNoneHistory:
    ...
    def test_reject_none_history(self):
        with pytest.raises(
            ...
            ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyEvaluationHistoryWindowBuilder().build(
                None,
                0,
                1,
            )
