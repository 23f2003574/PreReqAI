...
class TestRejectNoneHistory:
    ...
    def test_reject_none_history(self):
        with pytest.raises(
            ...
            ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionResolutionHistoryCursorBuilder().build(
                None,
                0,
            )
...
class TestImmutableAndDeterministicOutput:
    ...
    def test_repeated_build_is_deterministic(self):
        ...
        builder = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionResolutionHistoryCursorBuilder()
