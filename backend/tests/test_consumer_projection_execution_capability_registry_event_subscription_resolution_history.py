...
class TestEmptyHistory:
    ...
    def test_empty_history(self):
        history = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionResolutionHistoryBuilder().build(
            ()
        )
...
class TestRejectNoneCollection:
    ...
    def test_reject_none_collection(self):
        with pytest.raises(
            ...
            ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionResolutionHistoryBuilder().build(
                None
            )
...
class TestDeterminism:
    ...
    def test_repeated_build_is_deterministic(self):
        ...
        builder = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionResolutionHistoryBuilder()
