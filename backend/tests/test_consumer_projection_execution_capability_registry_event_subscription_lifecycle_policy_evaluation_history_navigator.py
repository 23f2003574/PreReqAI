...
def _navigator():
    return ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyEvaluationHistoryNavigator(
        ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyEvaluationHistoryCursorBuilder()
    )
...
class TestCursorBuilderInvokedForEveryReturnedCursor:
    ...
    def test_cursor_builder_invoked_for_every_returned_cursor(self):
        ...
        navigator = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyEvaluationHistoryNavigator(
            cursor_builder
        )
