...
def _entry(sequence_number, subscription=None):
    ...
    return ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryEntryBuilder().build(
        sequence_number,
        _execution_result(subscription),
    )
...
class TestBuildEmptyHistory:
    ...
    def test_build_empty_history(self):
        history = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryBuilder().build(
            ()
        )
...
class TestRejectNoneEntries:
    ...
    def test_reject_none_entries(self):
        with pytest.raises(
            ...
            ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryBuilder().build(
                None
            )
...
class TestDeterministicConstruction:
    ...
    def test_deterministic_construction(self):
        ...
        builder = ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecycleTransitionExecutionHistoryBuilder()
