...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileBindingPresetReleaseStatus(
    str,
    Enum,
):
    """
    ...
    preset version's controlled release lifecycle can occupy.
