...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileParameter:
    """
    ...
    Attributes:
        parameter_name: The parameter's unique name within its
            parameter set
        parameter_type: The Python type a supplied value must be an
            instance of, or None to accept any type
