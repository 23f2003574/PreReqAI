...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileBindingGroupReleaseStatus(
    str,
    Enum,
):
    """
    ...
    group version's controlled release lifecycle can occupy.
