...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileBindingTemplateCompatibilityResult:
    """
    ...
    event subscription lifecycle policy profile binding template is
    mutually compatible.
