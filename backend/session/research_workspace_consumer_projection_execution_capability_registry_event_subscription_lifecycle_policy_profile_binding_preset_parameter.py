...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileBindingPresetParameter:
    """
    Immutable description of a single configurable parameter a
    consumer projection execution capability registry event
    subscription lifecycle policy profile binding preset exposes.
    ...
    Attributes:
        name: The parameter's unique name within its preset's
            parameter set
