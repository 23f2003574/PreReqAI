...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileBindingTemplateReleaseStatus(
    str,
    Enum,
):
    """
    ...
    template version's controlled release lifecycle can occupy.
