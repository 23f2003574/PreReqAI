...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionResolutionHistoryNavigator:
    """
    ...
    def first(
        ...
        Args:
            history: The resolution history to navigate
