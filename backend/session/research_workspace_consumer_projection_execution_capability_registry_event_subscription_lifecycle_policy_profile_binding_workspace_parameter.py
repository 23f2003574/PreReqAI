...
class ResearchWorkspaceConsumerProjectionExecutionCapabilityRegistryEventSubscriptionLifecyclePolicyProfileBindingWorkspaceParameter:
    """
    Immutable description of a single configurable parameter a
    consumer projection execution capability registry event
    subscription lifecycle policy profile binding workspace exposes.
    ...
    Attributes:
        name: The parameter's unique name within its workspace's
            parameter set
