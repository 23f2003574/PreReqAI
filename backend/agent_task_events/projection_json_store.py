...
class JsonAgentTaskEventProjectionStore(AgentTaskEventProjectionStore):
    """Persists the latest AgentTaskEventProjection per task_id to a JSON
    file."""
    ...
    def get(self, task_id: str):
        ...
        return None if data is None else AgentTaskEventProjection.from_dict(data)
